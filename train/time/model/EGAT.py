...
class gat(nn.Module):
    def __init__(self):
        ...
        self.conv3 = dglnn.GATConv(hidden_dim, hidden_dim,num_heads=1, allow_zero_in_degree=True, bias=True).cuda()
...
#         torch.nn.init.xavier_normal_(self.linear1.weight, 5)
#         self.clasifier = nn.Linear(hidden_dim,1).cuda()
